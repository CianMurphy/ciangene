...
runSh='/cluster/project8/vyp/cian/scripts/bash/runBashCluster.sh'
####### Parameters
maf=0.000001	
missing=0.9
minVar=1e-4
...
echo "
$ldak  --calc-genes-reml $oDir --bfile $data --pheno $phenotypes --mpheno $mPheno --ignore-weights $ignoreWeights --minmaf $maf \
