phenotypes='/cluster/project8/vyp/cian/data/UCLex/UCLex_October2014/Lambiase_case_control/support/IVF.pheno' ; pheno='IVFvsUCL'
kinship='/scratch2/vyp-scratch2/cian/UCLex_October2014/Lambiase_case_control/IVF_all_kin'; kin='Tech'
extract='/cluster/project8/vyp/cian/data/UCLex/UCLex_October2014/Lambiase_case_control/whole_exome/gene_based/SNPs.func_extract' ; role='Func'
#!/bin/bash
