...
permPheno=${bDir}phenotype_combined_residual_fastlmm_perm
...
do
	...
	##plink --noweb  --bfile $data --logistic  --hide-covar --allow-no-sex --pheno $Pheno --adjust --mpheno $pheno --covar $covar --covar-number 1-2 --out 
$oDir$batch"_logistic_tech_pcs_covars"
	" > $oFile
